...
const Cart = () => {
    ...
    //re-render subtotal vs cart quantity sau mỗi lần tăng haowcj giảm số lượng sản phẩm.
    useEffect(() => {
        dispatch(getTotal())
    }, [cart, dispatch])
                    ...
                    <div className="start-shopping">
                        <Link to='/'>
                            <svg
                                ...
                                0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0
                                0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z" />
                            </svg>
